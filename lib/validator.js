...
const EXPECTED_TAG = process.env.AMAZON_ASSOCIATE_TAG || 'nagireddy0e-21';
...
class ProductValidator {
  ...
  static validateProductRecord(product, expectedTag = EXPECTED_TAG) {
    ...
    // 5. Image check
    if (!product.image_url || (!product.image_url.includes('media-amazon.com') && !product.image_url.includes('images-amazon.com') && !product.image_url.startsWith('https://'))) {
